            ...
            <div class='row'>
                <div class="col-sm-12">
                    ...
                    <div class="text-center">
                        ...
                        <h4>Jalan Desa Sengon Sari Dsn. 1 <br> Aek Kuasan, Kabupaten Asahan, Sumatera Utara, 21211</h4>
                        <hr>
                        <h3>DATA SISWA TAHUN   <? echo "$ambilthn"; ?></h3>
                        ...
                        <tbody>
                            ...
                            $sql = "SELECT * FROM tb_siswa WHERE substr(tgl_masuk,1,4)='$ambilthn'";
