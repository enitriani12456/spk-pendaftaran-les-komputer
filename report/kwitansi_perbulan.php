...
<html>
    <head>
        <title>Cetak Data Kwitansi Perbulan</title>
        <link href="../Assets/css/bootstrap.min.css" rel="stylesheet" type="text/css"/>
    </head>
    <body onload="print()">
        <!--Menampilkan data detail kwitansi-->
        <?php
            ...
            <div class='row'>
                <div class="col-sm-12">
                    ...
                    <div class="text-center">
                        ...
                        <hr>
                        <h3>DATA KWITANSI BULAN   <?php echo "$bulanNama $ambilthn"; ?></h3>
                ...
                <thead>
                            ...
                            $sql = "SELECT * FROM tb_kwitansi inner join tb_siswa on tb_kwitansi.nik=tb_siswa.nik WHERE substr(tanggal,1,7)='$ambilthn-$ambilbln'";
